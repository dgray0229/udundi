...
const onExplore = () => (showExplore.value = true);
const offExplore = () => (showExplore.value = false);
</script>
	...
	>
		<Transition name="fade">
			<section
				v-show="!showExplore"
				id="more-details"
				class="absolute col-start-2 col-span-6 row-start-6 row-span-2 flex flex-col justify-start rounded transition-colors duration-200 md:row-start-10 md:row-span-2 xl:col-start-2 xl:col-span-6"
			>
				<h2
				...
				>
					<img
						src="../assets/Plus.svg"
						class="w-[2.6875rem] h-auto pr-4 transform transition-transform duration-200 active:scale-80 hover:scale-110"
					/>&nbsp;<strong
